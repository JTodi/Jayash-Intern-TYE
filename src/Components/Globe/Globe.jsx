...
import { Logo, CountryNameBox, CountryModal } from '../index.js';
...
onMouseClick = (event) =>{
  ...
  for(let i = 0 ;i < intersects.length; i++){
    this.setState({
      ...
      pointClickedName : intersects[0].object.userData.Post,
    });
  }
}
  ...
  render(){
    ...
    const pointClickedName = this.state.pointClickedName;
    return (
      <>
        ...
        {(countryModalActive & pointClickedName == "San Diego") ? 
        <CountryModal 
        countryModal={countryModalActive} 
        data={countryData} 
